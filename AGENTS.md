...
Public constraint map for Britain. Progress Party instruments are labelled as instruments, with falsifiers.
...
- `/play` is Break the Slot: arcade boss rush. Instruments crack the slot; symptoms bounce. Do not add an engine, a hotel map, or a sixth root.
